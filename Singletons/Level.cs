...
public class Level : MonoBehaviour {
	...
	public void LoadLevel(){
		...
		key.transform.position = new Vector3(float.Parse(keyXML.GetValue("@x")), float.Parse(keyXML.GetValue("@y")), 0f);
		...
		foreach(XMLNode objectXML in levelObjectsXML){
			...
			switch(type){
				case "door":
					o = Instantiate(Resources.Load("Door", typeof(GameObject)) as GameObject as GameObject) as GameObject;
					...
					break;
				case "wallSwitch":
					o = Instantiate(Resources.Load("WallSwitch", typeof(GameObject)) as GameObject as GameObject) as GameObject;
					o.transform.position = new Vector3(float.Parse(objectXML.GetValue("@x")), float.Parse(objectXML.GetValue("@y")), .5f);
					o.transform.localScale = new Vector3(float.Parse(objectXML.GetValue("@sizeX")), float.Parse(objectXML.GetValue("@sizeY")), 1f);
					o.transform.parent = gameplay.transform;
					break;
				case "floorSwitch":
					o = Instantiate(Resources.Load("FloorSwitch", typeof(GameObject)) as GameObject as GameObject) as GameObject;
					o.transform.position = new Vector3(float.Parse(objectXML.GetValue("@x")), float.Parse(objectXML.GetValue("@y")), 0f);
					o.transform.localScale = new Vector3(float.Parse(objectXML.GetValue("@sizeX")), float.Parse(objectXML.GetValue("@sizeY")), 1f);
					o.transform.parent = gameplay.transform;
					break;
				case "block":
					o = Instantiate(Resources.Load("Block", typeof(GameObject)) as GameObject as GameObject) as GameObject;
					o.transform.position = new Vector3(float.Parse(objectXML.GetValue("@x")), float.Parse(objectXML.GetValue("@y")), 0f);
					o.transform.localScale = new Vector3(float.Parse(objectXML.GetValue("@sizeX")), float.Parse(objectXML.GetValue("@sizeY")), 1f);
					o.transform.parent = gameplay.transform;
					break;
