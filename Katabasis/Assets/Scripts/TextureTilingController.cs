...
public class TextureTilingController : MonoBehaviour {
    ...
    void UpdateTiling()
    {
        ...
        gameObject.renderer.material.mainTextureScale = new Vector2(planeSizeX*gameObject.transform.lossyScale.x/textureToMeshX, planeSizeY*gameObject.transform.lossyScale.y/textureToMeshY);
    }
}